...
<div class="logintop">    
    ...
    <li><font color="FF0033"><c:out value="${loginerr}"/></font></li>
    ...
    <div class="loginbm">版权所有  2014  <a href="http://www.wxbaoxi.com/">uimaker.com</a>  仅供学习交流，勿用于任何商业用途</div>
